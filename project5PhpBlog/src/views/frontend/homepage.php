      ...
      <div class="col-lg-9 mb-5 mb-lg-0" id="blogposts">
        <div class="row align-items-center mb-5">
          <?php foreach ($posts as $post) { ?>
            <div class="col-lg-6"><a class="d-block post-trending mb-4" href=""><img class="img-fluid w-100" src="<?= filter_var($post->getImage(), FILTER_SANITIZE_STRING); ?>" alt="" /></a>
            </div>
            <div class="col-lg-6">
              ...
              <p class="blogtext "><?= filter_var(substr($post->getChapo(), 0, 220), FILTER_SANITIZE_STRING) ?></p>
          ...
          <form action="index.php?action=contact" method="post">
            ...
            <div class="row">
              <div class="col">
                ...
                <textarea class="form-control" rows="4" id="message" name="message" value="<?= filter_var($mail['message'], FILTER_SANITIZE_STRING) ?>" required></textarea>
